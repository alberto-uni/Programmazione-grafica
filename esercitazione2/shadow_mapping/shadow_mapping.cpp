...
int main()
{
    ...
    // configurazione depth map e FBO
    // -----------------------
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //la posizione della luce cambia col passare del tempo
        ...
        // 1. generazione della depth map su proiezione ortografica 
        // --------------------------------------------------------------
        ...
        // render della scena dalla prospettiva della luce
        ...
        // 2. render della scena utilizzando lo shadow mapping
        // --------------------------------------------------------------
        glViewport(0, 0, SCR_WIDTH, SCR_HEIGHT);
        glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
        shader.use();
        ...
        // glfw: swap dei bufferper gli input da tastiera
        // -------------------------------------------------------------------------------
        glfwSwapBuffers(window);
        glfwPollEvents();
    }

    // de-allocamento risorse
    // ------------------------------------------------------------------------
...
// legge gli input ricevuti da tastiera, tasti W A S D ESC
// ---------------------------------------------------------------------------------------------------------
void processInput(GLFWwindow *window)
{
